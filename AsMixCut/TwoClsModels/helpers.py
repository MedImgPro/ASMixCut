...
from TwoClsModels.features import FeatureListNet, FeatureDictNet, FeatureHookNet
from TwoClsModels.layers import Conv2dSame
...
def load_pretrained(model, cfg=None, num_classes=1000, in_chans=3, filter_fn=None, strict=True):
    ...
    state_dict = torch.load( "/home/zouqingqing/.torch/models/se_cotnetd_50.pth.tar")
